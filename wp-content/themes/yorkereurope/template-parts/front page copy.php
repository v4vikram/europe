...
<section class="about-wrapper section-padding home_about">
    <div class="container">
        <?php $hero = get_field('about', 12);
        if ($hero): ?>
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img class="about-img-2" src="<?php echo esc_url($hero['image2']['url']); ?>"
    ...
    <div class="container">
        ...
        <div class="tour-section mt-5">
            <div class="tour-slider position-relative">
                <?php $special_tour_loop = new WP_Query(array(
                    'post_type' => 'package',
                    'posts_per_page' => -1,
                    'order' => 'ASC',
                    'package_category' => 'special_tour'
                )); ?>

                <?php if ($special_tour_loop->have_posts()): ?>
                    <?php while ($special_tour_loop->have_posts()):
                        $special_tour_loop->the_post(); ?>
                        <div class="d-inline-block">
                            <div class="single">
                                ...
                                <?php $hero_info = get_field('info');
                                if ($hero_info): ?>
                                    <span class="price">
                                        <i class="fa-solid fa-euro-sign"></i> <?php echo esc_html($hero_info['price']); ?>
                                        ...
                                        <div class="row facilities">
                                            <div class="col-8">
                                                <span class="time"><i class="fa-light fa-clock"></i>
                                                    <?php echo esc_html($hero_info['duration']); ?></span>
                                            </div>
                                            <div class="col-4">
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p>No special tours available.</p> <!-- Message if no posts are found -->
                <?php endif; ?>
...
<section class="hotdeals-wrapper section-padding">
    ...
    <div class="container">
        <div class="heading text-center">
            <span class="subtitle">END 2 END vacations SPECIALS</span>
            ...
            <div class="tour-slider position-relative">
                ...
                <?php if ($loop->have_posts()): ?>
                    <?php while ($loop->have_posts()):
                        ...
                        $isHotDeal = get_field('hot_deal');
                        $isSpecialTour = get_field('special_tour');

                        if ($isHotDeal || $isSpecialTour):

                            if ($isHotDeal[0] == 'yes' || $isSpecialTour[0] == 'yes'):
                                var_dump($isHotDeal[0]); ?>
                                    ...
                                    <div class="single">
                                        ...
                                        if ($hero): ?>
                                            <div class="details">
                                                ...
                                                <span class="price">
                                                    <i class="fa-solid fa-euro-sign"></i> <?php echo esc_html($hero['price']); ?>
                                                    <span>/ per person</span>
                                                </span>
                                                <div class="row facilities">
                                                    <div class="col-7 border-right">
                                                        <span class="time"><i
                                                                class="fa-light fa-clock"></i><?php echo esc_html($hero['duration']); ?></span>
                                                    </div>
                                ...
                                // Code to handle the case where it is not a hot deal
                                echo 'This package is not a hot deal.'; // You can change this message as needed
                            endif;

                        else:
                            // Code to handle the case where $isHotDeal is not set or is empty
                            // echo 'No hot deal information available.'; // You can change this message as needed
                        endif;
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p>No hot deals available.</p> <!-- Message if no posts are found -->
                <?php endif; ?>
...
<div class="callback-warapper text-center">
    <div class="container">
        <div class="inner">
            ...
            <div class="theme_btn">
                <a href="<?php echo get_site_url(); ?>/domestic-package">View Package</a>
            </div>
        </div>
    </div>
</div>
